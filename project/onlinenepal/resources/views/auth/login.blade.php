...
<main style="padding: 90px 20px; background: linear-gradient(to bottom right, #ffffff, #f7f9fc); min-height: 100vh; display: flex; justify-content: center; align-items: center;">
    <section class="login-register" style="width: 100%; max-width: 400px; padding: 30px 20px; background: #ffffff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); animation: fadeInSection 1.2s ease; margin: 250px 0;">
        <div style="width: 100px; height: 100px; margin: 0 auto 20px auto; position: relative;">
            <div style="width: 100px; height: 100px; background-color: #007bff; border-radius: 50%; animation: pulseRing 2s infinite; position: absolute; top: 0; left: 0; opacity: 0.5;"></div>
            <div style="width: 100px; height: 100px; background-image: url('https://cdn-icons-png.flaticon.com/512/3064/3064197.png'); background-size: contain; background-repeat: no-repeat; animation: lockRotate 1.5s infinite; position: relative;"></div>
        </div>
        <ul class="nav nav-tabs" id="login_register" role="tablist" style="margin-bottom: 30px;">
            <li class="nav-item" role="presentation" style="flex: 1;">
                <a class="nav-link active" id="login-tab" data-bs-toggle="tab" href="#tab-item-login" role="tab" aria-controls="tab-item-login" aria-selected="true" 
        ...
        <div class="tab-content" id="login_register_tab_content" style="padding-top: 10px;">
            <div class="tab-pane fade show active" id="tab-item-login" role="tabpanel" aria-labelledby="login-tab">
                <div class="login-form">
                    <form method="POST" action="{{ route('login') }}" name="login-form" class="needs-validation" novalidate="" style="animation: loginAnimation 2s ease;">
                        @csrf
                        ...
                        <div class="customer-option" style="margin-top: 20px; text-align: center;">
                            ...
                            <a href="{{ route('register') }}" style="color: #007bff; text-decoration: none; margin-left: 5px;">Create Account</a>
                            <br>
                            <span style="color: #6c757d;">Forgot Your Password?</span>
                            <a href="{{ route('forgot-password.email') }}" style="color: #007bff; text-decoration: none; margin-left: 5px;">Reset Password Now</a>
                        </div>
                    </form>
                </div>
            </div>
