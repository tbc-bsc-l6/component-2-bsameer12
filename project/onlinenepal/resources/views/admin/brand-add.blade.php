...
@section('website-content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.brand.save') }}" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand Name" name="name" tabindex="0"
                            value="{{ old('name') }}" aria-required="true" required aria-label="Brand Name">
                    </fieldset>
                    @error('name')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand Slug" name="slug" tabindex="0"
                            value="{{ old('slug') }}" aria-required="true" required aria-label="Brand Slug">
                    </fieldset>
                    @error('slug')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
