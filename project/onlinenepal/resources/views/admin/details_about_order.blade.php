            ...
            <div class="wg-box mt-5">
                ...
                <div class="my-account__address-item col-md-6">
                    <div class="my-account__address-item__detail">
                        ...
                        <p>City: {{ $order->city }}, {{ $order->district }}, {{ $order->province }} ,
                            {{ $order->country }} </p>
                        <p>Landmark: {{ $order->landmark }}</p>
                        <p>Zip Code: {{ $order->zip }}</p>
                        <br>
                        <p>Mobile: +977{{ $order->phone }}</p>
                    </div>
                </div>
            </div>
            <div class="wg-box mt-5">
                ...
                <form name="updateOrderStatus-form" id="updateOrderStatus-form" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <button type="submit" class="btn btn-primary tf-button w208" style="margin-top: 25px;">Update
                                Order Status</button>
                        </div>
                </form>
            </div>
