        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">Modify Brand</div>
                    </li>
                </ul>
            </div>
                ...
                <form class="form-new-product form-style-1" action="{{ route('admin.brand.update') }}" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand Name" name="name" tabindex="0"
                            value="{{ $brand->name }}" aria-required="true" required aria-label="Brand Name">
                    </fieldset>
                    @error('name')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand Slug" name="slug" tabindex="0"
                            value="{{ $brand->slug }}" aria-required="true" required aria-label="Brand Slug">
                    </fieldset>
                    @error('slug')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
