                        ...
                        <div id="galleryPreview" class="gallery-preview">
                            @if ($product->images)
                                @foreach (explode(',', $product->images) as $gallery_image)
                                    <img src="{{ asset('uploads/products/' . $gallery_image) }}"
                                        style="width:80px;height:80px;margin:5px;border:1px solid #ccc;border-radius:5px;object-fit:cover;">
                                @endforeach
                            @endif
                        </div>
                    </fieldset>
                    ...
                    <div class="cols gap22">
                        ...
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter sale price" name="sale_price"
                                tabindex="0" value="{{ $product->sales_price }}" aria-required="true" required="">
                        </fieldset>
                        @error('sale_price')
                            <span class="alert alert-danger text-center">{{ $message }}</span>
                        @enderror
                            ...
                            <div class="select mb-10">
                                <select class="" name="stock_status">
                                    <option value="instock"
                                        {{ isset($product->stock_status) && $product->stock_status == 'instock' ? 'selected' : '' }}>
                                        In Stock</option>
                                    <option value="outofstock"
                                        {{ isset($product->stock_status) && $product->stock_status == 'outofstock' ? 'selected' : '' }}>
                                        Out of Stock</option>
                                </select>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="featured">
                                    <option value="0"
                                        {{ isset($product->featured) && $product->featured == 0 ? 'selected' : '' }}>No
                                    </option>
                                    <option value="1"
                                        {{ isset($product->featured) && $product->featured == 1 ? 'selected' : '' }}>Yes
                                    </option>
                                </select>
                            </div>
                        </fieldset>
