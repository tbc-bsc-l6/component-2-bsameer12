                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <div class="text-tiny">Modify Product:</div>
                                        </li>
                                    </ul>
                                </div>
                                <!-- form-add-product -->
                                    ...
                                    <div class="wg-box">
                                        <fieldset>
                                            ...
                                            <div class="item" id="imgpreview" >
                                                <img src="{{ $product->image ? asset('uploads/products/' . $product->image) : '#' }}"  alt="">
                                            </div>
                                ...
                                <img src="images/upload/upload-1.png" alt="">
                                            ...
                                            @if($product->images)
                                                @foreach(explode(',', $product->images) as $gallery_image)
                                                    <img src="{{ asset('uploads/products/' . $gallery_image) }}" style="width:80px;height:80px;margin:5px;border:1px solid #ccc;border-radius:5px;object-fit:cover;">
                                                @endforeach
                                            @endif
                                            </div>
                                        </fieldset>
                                        ...
                                        <div class="cols gap22">
                                            ...
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="Enter sale price"
                                                    name="sale_price" tabindex="0" value="{{$product->sales_price}}" aria-required="true"
                                                    required="">
                                            </fieldset>
                                            @error('sale_price')
                                                <span class="alert alert-danger text-center">{{ $message }}</span>
                                        ...
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                ...
                                                <div class="select mb-10">
                                                    ...
                                                    <option value="instock" {{ (isset($product->stock_status) && $product->stock_status == 'instock') ? 'selected' : '' }}>In Stock</option>
                                                    <option value="outofstock" {{ (isset($product->stock_status) && $product->stock_status == 'outofstock') ? 'selected' : '' }}>Out of Stock</option>
                                                    </select>
                                                </div>
                                            </fieldset>
                                            @error('stock_status')
