        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href="{{ route('admin.slides.create') }}"><i class="icon-plus"></i>Add
                        new</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <a href="{{ route('admin.slides.modify', ['id' => $slide->id]) }}">
                                                <div class="item edit">
                                                    <i class="icon-edit-3"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('admin.slide.remove', ['id' => $slide->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
